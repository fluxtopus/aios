#!/usr/bin/env python3
"""CLI tool for managing Tentacle authentication."""
...
@click.group()
def auth():
    """Manage Tentacle authentication and API keys."""
    pass
...
def generate_env(output: Optional[str]):
    ...
    env_vars = f"""# Tentacle Authentication Configuration
# Generated on {datetime.utcnow().isoformat()}

# Secret key for JWT signing (change in production!)
TENTACLE_SECRET_KEY={secrets.token_urlsafe(32)}

# Token expiration time in minutes
TENTACLE_TOKEN_EXPIRE_MINUTES=30
