...
class TaskEventPublisher:
    ...
    async def inbox_message_created(
        ...
        Publishes to tentacle:inbox:events:{user_id} so each user gets
        ...
        channel = f"tentacle:inbox:events:{user_id}"
        await self._redis_client.publish(channel, json.dumps(event.to_dict()))
    ...
    async def inbox_status_updated(
        ...
        Publishes to tentacle:inbox:events:{user_id}.
    ...
    def get_inbox_channel(self, user_id: str) -> str:
        ...
        return f"tentacle:inbox:events:{user_id}"
