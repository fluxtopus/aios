...
"""Mimic notification client for Tentacle.
...
class NotificationType(str, Enum):
    """Types of notifications Tentacle can send."""
...
class TentacleMimicClient:
    """Mimic client configured for Tentacle task notifications.
    ...
    def __init__(
        ...
        """Initialize Tentacle Mimic client.
        ...
        logger.info(
            "TentacleMimicClient initialized",
...
_client: Optional[TentacleMimicClient] = None


def get_mimic_client() -> TentacleMimicClient:
    """Get or create the singleton Mimic client.

    Returns:
        TentacleMimicClient instance
    """
    global _client
    if _client is None:
        _client = TentacleMimicClient()
    return _client
