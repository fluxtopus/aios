...
"""FastAPI application for Tentacle tasks, inbox, integrations, and agent management."""
...
async def lifespan(app: FastAPI):
    ...
    await audit_logger.log_workflow_event(
        ...
        description="Tentacle API started",
        details={
            "version": "1.0.0",
    ...
    await audit_logger.log_workflow_event(
        ...
        description="Tentacle API shutting down",
        details={}
    )
...
def setup_api_routes_sync(app: FastAPI, **dependencies):
    ...
    async def health():
        ...
        return {"status": "healthy", "service": "tentacle"}
...
app = FastAPI(
    title="Tentacle API",
    description="Tasks, inbox (Flux), integrations, and agent management for Tentacle",
    version="1.0.0",
    lifespan=lifespan
)
