...
SECRET_KEY = os.getenv("TENTACLE_SECRET_KEY") or settings.SECRET_KEY or ""
ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = int(os.getenv("TENTACLE_TOKEN_EXPIRE_MINUTES", "30"))
...
class AuthMiddleware:
    ...
    async def _get_webhook_secret(self, source: str) -> Optional[str]:
        ...
        key pattern as EventGateway (``tentacle:gateway:source:<source>``).
        ...
        try:
            ...
            try:
                source_key = f"tentacle:gateway:source:{source}"
    ...
    async def create_api_key(
        ...
        api_key = f"tentacle_{secrets.token_urlsafe(32)}"
