"""Mimic Integration client for Tentacle.

This module provides a singleton Mimic client for integration management
throughout the Tentacle application.
...
through Mimic. Tentacle uses the Mimic SDK to:
...
async def send_followup(
    ...
    This allows Tentacle workflows/agents to respond to Discord slash
