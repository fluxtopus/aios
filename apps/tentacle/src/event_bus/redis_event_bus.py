...
class RedisEventBus(EventBusInterface):
    ...
    def __init__(self, redis_url: str = None, db: int = 0, key_prefix: str = "tentacle:eventbus"):
    ...
    async def _subscribe_to_pattern(self, pattern: str):
        ...
        'tentacle:eventbus:events:type:external.webhook.*'

        This matches channels like:
        'tentacle:eventbus:events:type:external.webhook.order.created'
        """
        channels = []
