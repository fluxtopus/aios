...
Required environment variables:
    ...
    TENTACLE_API_BASE: (optional) Base URL for the events API. Defaults to http://localhost:8000/api/events.
"""
...
API_BASE = os.environ.get("TENTACLE_API_BASE", "http://localhost:8000/api/events")
