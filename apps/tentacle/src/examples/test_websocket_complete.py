...
Required environment variables:
    TENTACLE_ADMIN_TOKEN: Bearer token for admin authentication (from InkPass login).
    TENTACLE_API_BASE: (optional) Base URL for the events API.
    TENTACLE_WS_BASE: (optional) WebSocket base URL for the events API.
"""
...
API_BASE = os.environ.get("TENTACLE_API_BASE", "http://api:8000/api/events")
WS_BASE = os.environ.get("TENTACLE_WS_BASE", "ws://api:8000/api/events")
ADMIN_TOKEN = os.environ.get("TENTACLE_ADMIN_TOKEN", "")
...
async def test_complete_flow():
    ...
    await pubsub.psubscribe("tentacle:eventbus:events:*")
