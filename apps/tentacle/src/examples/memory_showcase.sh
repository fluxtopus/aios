#!/usr/bin/env bash
# =============================================================================
#  Tentacle Agent Memory — Real-Life Scenario Demo
# =============================================================================
#
#  Scenario: AI-Powered Customer Success Team
#  ───────────────────────────────────────────
#  A SaaS company ("Acme Cloud") uses Tentacle agents to run their
...
#
#  Run:
#    bash apps/tentacle/src/examples/memory_showcase.sh
#
#  Requirements:
#    - inkpass running on port 8004
#    - tentacle running on port 8005
#    - jq installed
#
...
#    TENTACLE_URL  - Tentacle URL (default: http://localhost:8005)
# =============================================================================
...
TENTACLE_URL="${TENTACLE_URL:-http://localhost:8005}"
...
echo -e "  ${BOLD}The Tentacle Agent Memory system enables:${NC}"
echo ""
