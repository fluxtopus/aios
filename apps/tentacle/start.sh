#!/bin/bash
# Startup script for Tentacle API Service
...
echo "Starting Tentacle API Service..."
...
if [ -n "$DATABASE_URL" ]; then
    ...
    DB_USER="${POSTGRES_USER:-tentacle}"
fi
...
echo "Starting Tentacle API server on port ${PORT:-8000}..."
